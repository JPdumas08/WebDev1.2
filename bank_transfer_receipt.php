...
<head>
    ...
    <title>Bank Transfer Payment Receipt - Jeweluxe</title>
                ...
                <div class="card receipt-card shadow-lg border-0 rounded-4">
                    <div class="card-body p-5">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted mb-0">Your bank transfer payment has been confirmed</p>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold text-end"><span class="badge bg-success">Bank Transfer</span></td>
                                </tr>
                                <tr>
                        ...
                        <div class="alert alert-info">
                            ...
                            <p class="small mb-0">
                                <strong>Transfer Via:</strong> Bank Transfer<br>
                                <strong>Bank Name:</strong> BDO Unibank<br>
